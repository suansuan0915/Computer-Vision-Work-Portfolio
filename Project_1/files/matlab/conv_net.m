function [cp, param_grad] = conv_net(params, layers, data, labels)
    ...
    %% Loss layer
    i = l;
    assert(strcmp(layers{i}.type, 'LOSS') == 1, 'last layer must be loss layer');  % strcmp -logical compare two strings
    ...
    if nargout >= 2
        ...
        param_grad{i-1}.b = param_grad{i-1}.b /batch_size;  % compute param_grad.w & b
    end
